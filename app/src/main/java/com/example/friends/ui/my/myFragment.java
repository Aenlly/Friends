...
public class myFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //修改密码按钮单击事件
        view.findViewById(R.id.btn_my_checkpwd).setOnClickListener(new View.OnClickListener() {
            @Override
...
//                        .navigate(R.id.action_navigation_my_to_navigation_my_checkpwd);
        ...
        //退出登录按钮单击事件
        view.findViewById(R.id.btn_my_nologin).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //获得文件
