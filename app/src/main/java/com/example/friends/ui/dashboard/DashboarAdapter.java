...
public class DashboarAdapter extends BaseAdapter {
    ...
    private DashboardFragment dashboardFragment;//创建句柄
    private List<FriendDashboard> list;
    private LayoutInflater inflater;

    public DashboarAdapter(DashboardFragment dashboardFragment, List list) {
        this.dashboardFragment = dashboardFragment;;//获得句柄
        this.list = list;//获得list数据
        inflater = (LayoutInflater) dashboardFragment.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);//获得视图的实例
    }
